...
def analyze_ligo_dump(filename, system_type='AUTO', expected_m_chirp_solar=None):
    ...
    # ==========================================================
        ...
        if len(data_hilb) > 10:
            ...
            checkpoints = [-15.0, -10.0, -5.0, -2.5, -1.0, -0.75, -0.5, -0.35,
            ...
            # inspiral pulito; per i BBH (chirp attesa pesante) gli ultimi ~0.2 s sono
            # plunge post-ISCO, dove il tracker Hilbert non e' affidabile: si fitta prima.
